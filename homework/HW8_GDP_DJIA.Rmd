...
gdp_djia |> 
  ggplot() +
  geom_point(aes(x=GDP, y=DJIA, label=Quarter)) +
...
I believe the relationship between the DJIA and GDP seen on the scatterplot is somewhat of a strong correlation between the two variables — as the scatterplot shows a growing path through increased data on both the x and y axis, respectively. Also, the data seen on the scatterplot is generally all close together, seen along the same general path with limited outliers, thus making it a strong, positive and growing correlation between both variables.
