...
The distribution of danceability scores in the Spotify dataset looks to be mostly normal, but is a bit skewed left. The mean and one standard distribution tells us that the songs in the dataset are mostly above average in relation to danceability scores, with averages stacked between lower and upper bounds above both 0.4 and 0.8 — as a story pitch may be that the distribution shows that the danceability scores are high within the distribution, but can still be seen as somewhat skewed and not representative of all spotify song scores.
