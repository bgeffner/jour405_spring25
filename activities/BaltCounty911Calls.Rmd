...
If I had to draw horizontal lines that would highlight unusual days, the upper bound would be around 17 and the lower bound would hover at 4. Some patterns present include a generally higher number of positively high unusual 911 overdose call days during the summer months, while specific winter days may have higher single-day spikes but an overall lower number of positively high unusual days — thus maybe correlating back to the theme seen in the murder study, that more individuals are likely to buy drugs, overdose or be found overdosing during the summer than the winter.
...
These unusual days in the context of the full dataset doesn't differ much from my answer on Task 3 - I seemingly was relatively correct on what's considered to be unusually high and low days specifically. More similarities are present than differences, as my respective upper and lower bounds were 17 and 4 calls per each unusual day — most of which are represented in these unusual scores here. While these days are definitely more sensitive in relation to viewing unusual days, widely seen outliers such as 20+ and less than 3 calls per day numbers are reflected across both this and my opinion in Task 3.
...
Tuesday, followed by Thursday, marked the day of the week pattern with the highest representative positive separation and separation in 911 Overdose Calls.
...
Some potential angles for reporting might include taking a deep dive into specific differences seen over the course of a given week — and why certain days, such as Saturday, Sunday, Thursday and Tuesday, hold overwhelmingly high individual call counts and z-scores. A hypothesis may be connected to the belief that more individuals are likely to be outside and/or available to report on overdoses or present to overdose themselves during end of week and weekend days, rather than busier midweek days specifically. My next steps would be to further analyze this data on a per-day basis over a broader span, while telling an editor that both summer and weekend days in specific might correlate to a higher spread and a higher probability for positive spikes in 911 drug overdose call counts in Baltimore County.
