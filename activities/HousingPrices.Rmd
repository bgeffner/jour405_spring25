...
The new light rail transit line represents and is causing an increase in home propety values. Recent home sales have gradually increased since the transit line has been built — now neighborhood average rankings now upwards of $300,000 (compared to a previous average of just 285,000). The overall mean has jumped from 285,000 to 304,500, respectively, thus noting a clear causation and correlation to support local officials' claims on the impact on translit line in comparison to elevated neighborhood property values.
