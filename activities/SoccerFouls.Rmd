...
Both the correlation calculation and the scatterplot depicts a varying relationship, essentially not showing a direct linear correlation. The results depict limited goal differential near the center of the scatterplot, with increased fouls connecting to reduced goal difference — though somewhat of a large spread can be seen in goal differential (with lower bound of -10 and upper bound of positive 10), correlated fouls are stacked within the center of the calculation.
