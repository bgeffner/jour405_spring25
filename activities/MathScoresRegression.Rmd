...
Based on the above scatterplot, though the linear regression line represents a gradually positive relationship between the FARMS percentage and the math test scores, a majority of specific data points are increasingly high or low outliers and may connect to the belief that the percent met of exceeded math expectations are increasingly varied and not definitively consistent as a whole, though still on an upwards linear regression line/trend.
...
Based on what I've learned so far, I believe this model may be worth using, as it could help shed light on and help provide specific math scores while measuring how much of the difference between schools' math scores could be explained by respective FARMS percentages — telling us, based on minimum and maximum residual values, the exact amount of spread between actual and expected scores, with a wide relationship that may show a faulty model.
...
Some schools with the largest differences between the predicted result and actual math scores — both positive and negative — include Whitemarsh Elementary, Gulph Elementary, Lower Gwynedd Elementary, Crooked Billet Elementary and Woodland Elementary. The largest upper and lower bound differences are over 30 on each side. Though certain specific schools in the dataset have correlations between expected and actual observed frequencies, it's increasingly limited compared to heightened skewed results and may be related more to just pure chance than actual confirmed/interconnected results — further relating to the belief that the data model is faulty between predicted results and actual math scores.
...
I'd conclude that an array of the information is being cherrypicked to fit within a certain narrative, and that this model's results may be somewhat faulty and difficult to track — the visualized relationship between the FARMS (Free and Reduced-price Meal System) percentage and the percentage of students who met or exceeded math expectations represents outliers that could influence the accuracy of this relationship. The "schools" dataset shows the pure randomness of met/exceeded student math scores based on specific school locations, how certain schools in underprivileged/limited resource rural areas may show exceedingly high or disappointingly low scores — not showing much of a consistent trend that might also connect to the belief that fewer students on free price meals do better on tests. This represents the idea that there's not enough evidence to confirm this story trend, and may not be fully accurate.
